...
public class Dashbord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGenerate.setText("jButton1");
        jPanel2.add(btnGenerate, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 330, -1, -1));

        btnPrint.setText("jButton1");
        jPanel2.add(btnPrint, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 130, -1, -1));

        txtReport.setColumns(20);
        txtReport.setRows(5);
        jScrollPane1.setViewportView(txtReport);

        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 250, 250, 300));
